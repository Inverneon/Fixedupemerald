...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_SOOTHING_AROMA, ABILITY_GRASSEY_SURGE, ABILITY_NONE },
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_STRONG_JAW, ABILITY_NONE },
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLUFFY, ABILITY_KEEN_EYE, ABILITY_NONE },
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .abilities = { ABILITY_TINTED_LENS, ABILITY_KEEN_EYE, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_BROWN,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_ILLUMINATE, ABILITY_FLUFFY, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_WHITE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_ILLUMINATE, ABILITY_MOLD_BREAKER, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .baseDefense   = 80,
        .baseSpeed     = 50,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 75 : 50,
        .baseSpDefense = 80,
    #if P_UPDATED_TYPES >= GEN_6
        .types = MON_TYPES(TYPE_WATER, TYPE_NORMAL),
    #else
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .abilities = { ABILITY_AERILATE, ABILITY_LEAF_GUARD, ABILITY_INFILTRATOR },
    #else
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_FLORAL_FURY, ABILITY_CHLOROPHYLL, ABILITY_EARLY_BIRD },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_EARLY_BIRD },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LEVITATE, ABILITY_TINTED_LENS, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_GREEN,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CUD_CHEW, ABILITY_SAP_SIPPER, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STURDY, ABILITY_QUICK_DRAW, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_RATTLED, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_RATTLED, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_IRON_BARBS, ABILITY_INTIMIDATE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_GUTS, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_POISON_POINT, ABILITY_UNBURDEN, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .description = COMPOUND_STRING(
            ...
            "hope to best it on Mt. Chimney. It\n"
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_WEAK_ARMOR, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_COMMANDER, ABILITY_SNIPER, ABILITY_MOODY },
    #else
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKUP, ABILITY_SAND_FORCE, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INTIMIDATE, ABILITY_PSYCHIC_SURGE, ABILITY_NONE },
    #else
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FUR_COAT, ABILITY_PSYCHIC_SURGE, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .abilities = { ABILITY_RAGING_THUNDER, ABILITY_VOLT_ABSORB, ABILITY_NONE },
    #else
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_GOUGING_INFERNO, ABILITY_FLASH_FIRE, ABILITY_NONE },
    #else
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_WALKING_AURORA, ABILITY_WATER_ABSORB, ABILITY_NONE },
    #else
