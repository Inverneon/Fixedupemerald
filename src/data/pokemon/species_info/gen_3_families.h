...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_SOLAR_POWER, ABILITY_UNBURDEN },
    ...
    [SPECIES_GROVYLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHARPNESS, ABILITY_SOLAR_POWER, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_FUR_COAT, ABILITY_SPEED_BOOST },
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HONEY_GATHER, ABILITY_BERSERK, ABILITY_RIVALRY },
...
#if P_FAMILY_RALTS
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_PSYCHIC : TYPE_PSYCHIC)
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_WATER_BUBBLE, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .baseAttack    = 80,
        .baseDefense   = 62,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 102 : 60,
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SAND_FORCE, ABILITY_MAGNET_PULL, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        .baseAttack    = 70,
        .baseDefense   = 65,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 111 : 70,
        .baseSpAttack  = 55,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 60,
    ...
    #define MAWILE_TYPES { TYPE_STEEL, TYPE_DARK }
#else
    ...
    [SPECIES_MAWILE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_INTIMIDATE, ABILITY_SHEER_FORCE },
    ...
    [SPECIES_AGGRON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SEED_SOWER, ABILITY_ROCK_HEAD, ABILITY_HEAVY_METAL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MANECTRIC] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_FLARE_BOOST, ABILITY_MINUS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .abilities = { ABILITY_STRONG_JAW, ABILITY_SPEED_BOOST, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_DROUGHT, ABILITY_SHELL_ARMOR },
    #else
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_VIBRAVA}),
    },
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #endif
        .abilities = { ABILITY_LEVITATE, ABILITY_SHEER_FORCE, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CACTURNE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_IRON_BARBS, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_DUSCLOPS}),
    },
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_HARVEST, ABILITY_HARVEST },
    #else
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_DARK_AURA, ABILITY_SUPER_LUCK, ABILITY_JUSTIFIED },
    #else
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LEVITATE, ABILITY_SNOW_WARNING, ABILITY_MOODY },
    #else
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_MOODY },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_KYOGRE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ANCIENT_DOWNPOUR, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GROUDON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SOLAR_STORM, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
