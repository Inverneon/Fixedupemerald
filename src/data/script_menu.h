...
static const struct MenuAction MultichoiceList_Difficulties[] =
{
    {COMPOUND_STRING("VANILLA")},
    {COMPOUND_STRING("VANILLA DBL")},
    {COMPOUND_STRING("CHALLENGE")},
    {COMPOUND_STRING("LUNATIC")},
    {gText_Exit},
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_DIFFICULTIES]               = MULTICHOICE(MultichoiceList_Difficulties),
};
