...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_TWINEEDLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Jabs twice with stingers. 2x damage if target is poisoned."),
        .effect = EFFECT_HIT,
        .power = 30,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_ACID] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "That deals 2x damage to Steel types."),
        #else
            "May lower Defense."),
        #endif
        ...
        .argument = { .type = TYPE_STEEL },
            .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = B_UPDATED_MOVE_DATA >= GEN_4 ? MOVE_EFFECT_DEF_MINUS_1 : MOVE_EFFECT_DEF_MINUS_1,
            .chance = 10,
        }),
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_SMART,
    ...
    [MOVE_DRILL_PECK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the beak acting as a drill. High crit-rate."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_KINESIS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Reverses everyones movement.\n"
            "Making slow pokemon faster."),
    ...
    [MOVE_POISON_GAS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Envelops the field in a toxic\n"
            "gas that poisons foes."),
        #if B_UPDATED_MOVE_DATA >= GEN_6
            .accuracy = 00,
        #elif B_UPDATED_MOVE_DATA >= GEN_5
            .accuracy = 80,
        ...
        .type = TYPE_POISON,
        .pp = 40,
        .target = B_UPDATED_MOVE_DATA >= GEN_5 ? MOVE_TARGET_OPPONENTS_FIELD : MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_DEF_UP_1 },
        .magicCoatAffected = TRUE,
    ...
    [MOVE_BONEMERANG] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that strikes twice. Hits Airbone Targets"),
    ...
    [MOVE_ASTONISH] =
    {
        ...
        .description = COMPOUND_STRING(
            "An attack that strikes first to shock\n"
            "the foe."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GHOST,
    ...
    [MOVE_AIR_CUTTER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "High critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 75 : 55,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .criticalHitStage = 1,
        .pp = 25,
    ...
    [MOVE_LEAF_BLADE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "High critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 50 : 70,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .criticalHitStage = 0,
        .pp = 15,
