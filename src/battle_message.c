...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_POISONSPIKESSCATTERED]                = COMPOUND_STRING("A poisonous gas envoloped {B_DEF_TEAM2} team!"),
    ...
    [STRINGID_TOXICSPIKESABSORBED]                  = COMPOUND_STRING("The poisonous gas disappeared from the air around {B_SCR_TEAM2} team!"),
    ...
    [STRINGID_PKMNBLEWAWAYTOXICSPIKES]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} blew away Poisonous Gas!"),
    ...
    [STRINGID_TOXICSPIKESDISAPPEAREDFROMTEAM]       = COMPOUND_STRING("The poisonous gas disappeared from the air around {B_ATK_TEAM2} team!"),
    ...
    [STRINGID_COMMANDERACTIVATES]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} Clung onto Mantine!"),
